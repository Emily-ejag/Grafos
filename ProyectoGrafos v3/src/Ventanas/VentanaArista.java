         ...
         if(x==y)
           JOptionPane.showMessageDialog(null,"Error.. Debe digitar un nodo diferente a : "+y);
            ...
            JOptionPane.showMessageDialog(null,"Error.. Nodos No validos "); 
             ...
             arboles.setmAdya(x, y, 1);
             arboles.setmAdya(y, x, 1);
             arboles.setmCoe(x, y, ta);
             arboles.setmCoe(y, x, ta);
             n1.setText(null);
             n2.setText(null);
             tm.setText(null);
            Pintar.pintarArista(VentanaPrincipal.jPanel1.getGraphics(),arboles.getCordeX(x), arboles.getCordeY(x), arboles.getCordeX(y), arboles.getCordeY(y), ta);
